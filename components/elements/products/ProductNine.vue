    ...
    <div class="product product-7 text-center">
        <figure class="product-media">
            ...
            <nuxt-link :to="'/product/centered/'+ product.id">
                ...
                />
                <img
                    v-lazy="`${product.product_image[1].image_url}`"
                    alt="Product"
            ...
            <div class="product-action-vertical" v-if="product.details.opening_stock !== 0">
                <nuxt-link
                    to="/shop/wishlist"
            ...
            <div class="product-action" v-if="product.details.opening_stock !== 0">
                <!-- <nuxt-link
